	...
	return (
		<div className='lg:flex lg:justify-between max-w-screen-xl mx-auto w-full py-4'>
			...
			<div className='gap-4 flex justify-center text-sm items-center lg:justify-end'>
				<a href='https://www.manestudio.xyz' target='_blank' className='hover:text-gray-400'>
					ManeSTUDIO
				</a>
				<a href='https://www.maneslab.xyz' target='_blank' className='hover:text-gray-400'>
					ManesLAB
				</a>
				<a href='https://twitter.com/manestudioxyz' target='_blank' className='hover:text-gray-400'>
					<TwitterIcon className='icon-xs' />
				</a>
				<a href='https://github.com/maneslab/manestudio.xyz' target='_blank' className='hover:text-gray-400'>
